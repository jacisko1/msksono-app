...
const jointPositioningBySlug: Record<string, JointPositioningContent> = {
  rameno: {
    ...
    intro: {
      cs: "SchĂ©ma ukazuje doporuÄŤenĂ© nastavenĂ­ pacienta, konÄŤetiny a sondy pro zĂˇkladnĂ­ vyĹˇetĹ™enĂ­ ramene. CĂ­lem je rychlĂˇ orientace pĹ™ed samotnĂ˝m protokolem.",
    ...
    positions: {
      cs: [
        "PĹ™ednĂ­ pohled (vsedÄ›, ruka v neutrĂˇlu): zĂˇkladnĂ­ orientace v oblasti dlouhĂ© hlavy bicepsu a rotĂˇtorovĂ© manĹľety.",
        "PĹ™ednĂ­ pohled (vnitĹ™nĂ­/zevnĂ­ rotace): dynamickĂ© hodnocenĂ­ subscapularis, bicepsu a stability sulku.",
        "LaterĂˇlnĂ­ pohled: zobrazenĂ­ supraspinatu a subakromiĂˇlnĂ­-subdeltoidnĂ­ burzy, vhodnĂ© pĹ™i bolestivĂ©m oblouku.",
        "DorzĂˇlnĂ­ pohled: hodnocenĂ­ infraspinatu, zadnĂ­ho recesu a zadnĂ­ ÄŤĂˇsti glenohumerĂˇlnĂ­ho kloubu."
      ],
      en: [
  ...
  loket: {
    imageBaseName: "loket",
    intro: {
      cs: "PĹ™ehled polohovĂˇnĂ­ lokte sjednocuje polohu pacienta a smÄ›r sondy, aby bylo vyĹˇetĹ™enĂ­ reprodukovatelnĂ© a dobĹ™e porovnatelnĂ© mezi stranami.",
  ...
  zapesti: {
    ...
    intro: {
      cs: "SchĂ©ma pro zĂˇpÄ›stĂ­ pomĂˇhĂˇ rychle nastavit ruku a sondu pro ventrĂˇlnĂ­ i dorzĂˇlnĂ­ skenovĂˇnĂ­ vÄŤetnÄ› karpĂˇlnĂ­ho tunelu a extenzorovĂ˝ch kompartmentĹŻ.",
  ...
  kycel: {
    imageBaseName: "kycel",
    intro: {
      cs: "PolohovĂˇnĂ­ kyÄŤle je zamÄ›Ĺ™enĂ© na stabilnĂ­ orientaci v hlubĹˇĂ­ch strukturĂˇch. ObrĂˇzek shrnuje doporuÄŤenou polohu pacienta a vedenĂ­ sondy pro jednotlivĂ© pĹ™Ă­stupy.",
  ...
  koleno: {
    ...
    intro: {
      cs: "U kolene je dĹŻleĹľitĂˇ konzistentnĂ­ poloha v extenzi i flexi. PĹ™ehled ukazuje, jak pacienta nastavit pro pĹ™ednĂ­, mediĂˇlnĂ­, laterĂˇlnĂ­ a zadnĂ­ projekce.",
  ...
  kotnik: {
    ...
    intro: {
      cs: "SchĂ©ma pro kotnĂ­k shrnuje nejpouĹľĂ­vanÄ›jĹˇĂ­ pozice nohy a sondy pro pĹ™ednĂ­, mediĂˇlnĂ­, laterĂˇlnĂ­ i zadnĂ­ pĹ™Ă­stup vÄŤetnÄ› dynamickĂ˝ch testĹŻ stability.",
      ...
      <section className={styles.stack}>
        ...
        <section className={styles.articleBox}>
          ...
          <ResponsiveImage
            ...
            alt={
              lang === "cs"
                ? `PolohovĂˇnĂ­ pacienta a sondy: ${localize(node.title, lang)}`
            ...
            caption={
              lang === "cs"
                ? `PolohovĂˇnĂ­ - ${localize(node.title, lang)}`
      ...
      <section className={styles.stack}>
        ...
        <section className={`${styles.articleBox} ${styles.anatomyLayout}`}>
          ...
          <section className={styles.anatomyCard}>
            ...
            <div className={`${styles.swipeGallery} ${styles.anatomyGallery}`} aria-label={lang === "cs" ? "Galerie svalů ramene" : "Shoulder muscle gallery"}>
