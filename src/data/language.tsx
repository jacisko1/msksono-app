...
const translations = {
  ...
  homeIntro: {
    cs: "Praktická výuka muskuloskeletální ultrasonografie v jasnì strukturovaných modulech.",
  ...
  offlineMessage: {
    cs: "Aplikace bìží bez pøipojení. Døíve naètené sekce zùstávají dostupné.",
  ...
  installAndroidHint: {
    cs: "V Android Chrome otevøete menu prohlížeèe (tøi teèky) a zvolte Pøidat na plochu nebo Instalovat aplikaci.",
    en: "In Android Chrome, open the browser menu (three dots) and choose Add to Home screen or Install app."
  },
  installSecureHint: {
    cs: "Instalace PWA vyžaduje zabezpeèené pøipojení HTTPS. Otevøete aplikaci pøes HTTPS URL a zkuste to znovu.",
    en: "PWA installation requires a secure HTTPS connection. Open the app via an HTTPS URL and try again."
  },
  installUnavailableHint: {
    cs: "Instalace není v tomto prohlížeèi právì dostupná. Zkuste nabídku prohlížeèe: Pøidat na plochu.",
  ...
  accountProgressHint: {
    cs: "Postup je poèítaný podle hotových podstránek v jednotlivých sekcích.",
  ...
  upLevel: { cs: "O úroveò výše", en: "Up one level" }
} as const;
