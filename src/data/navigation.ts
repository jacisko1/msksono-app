...
const nerveChildren = (basePath: string): RawNavItem[] => [
  ...
  {
    title: { cs: "Anatomický prùbìh", en: "Anatomical course" },
    path: `${basePath}/anatomicky-prubeh`
  },
  {
    title: { cs: "Ultrazvukové vyšetøení", en: "Ultrasound examination" },
    ...
    children: withSection("klouby", "#00626c", [
      {
        ...
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/rameno/nejcastejsi-patologie" }
        ]
      },
      {
        ...
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/loket/nejcastejsi-patologie" }
        ]
      },
      {
        title: { cs: "Zápìstí a ruka", en: "Wrist and hand" },
        path: "/klouby/zapesti",
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/zapesti/nejcastejsi-patologie" }
        ]
      },
      {
        title: { cs: "Kyèel", en: "Hip" },
        path: "/klouby/kycel",
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/kycel/nejcastejsi-patologie" }
        ]
      },
      {
        ...
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/koleno/nejcastejsi-patologie" }
        ]
      },
      {
        ...
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/klouby/kotnik/nejcastejsi-patologie" }
        ]
      }
    ])
  },
    ...
    children: withSection("svaly", "#9a2626", [
      {
        ...
        children: [
          ...
          { title: { cs: "Nejèastìjší patologie", en: "Most common pathologies" }, path: "/svaly/biceps-brachii/nejcastejsi-patologie" }
        ]
      }
    ])
  }
